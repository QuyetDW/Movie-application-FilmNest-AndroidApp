...
public class ListMoviesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (category != null){
            ...
            textViewTitle.setText("Tất cả phim");
        }
    ...
    private void fetchFilms(String category){
        if(category == null){
            Toast.makeText(this, "Không xác định được danh mục", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        switch (category){
            ...
            case "Sắp Chiếu":
                ...
                break;
            default:
                refKey = "Items"; // danh mục mặc định
        }

        DatabaseReference myref = database.getReference(refKey);
        ...
        myref.addListenerForSingleValueEvent(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot){
                if(snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        ...
                        Toast.makeText(ListMoviesActivity.this, "Không có phim nào trong danh mục này.", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(ListMoviesActivity.this, "Không có dữ liệu trong danh mục này.", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onCancelled(@NonNull DatabaseError error){
                binding.progressBarAllFilms.setVisibility(View.GONE);
                Toast.makeText(ListMoviesActivity.this, "Lỗi khi lấy dữ liệu: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.getRef().equals(itemsRef)) {
                    if (!films.isEmpty()) {
                        ...
                        Toast.makeText(ListMoviesActivity.this, "Không có phim nào có điểm IMDB trên 8.", Toast.LENGTH_SHORT).show();
                    }
                    binding.progressBarAllFilms.setVisibility(View.GONE);
                }
            }
